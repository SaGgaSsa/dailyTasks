...
curl -X POST http://localhost:3000/api/ingest \
  ...
  -H "x-api-secret: nw8N6oj3tGInfnb3jsN824J54cut88BA" \
...
1. **Cambiar la clave secreta**: Asegúrate de cambiar `nw8N6oj3tGInfnb3jsN824J54cut88BA` por el valor que definas en tu `.env`
