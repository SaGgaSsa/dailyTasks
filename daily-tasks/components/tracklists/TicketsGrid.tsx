    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="w-24">Estado Dev</TableHead>
          <TableHead className="w-24">Estado QA</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {initialTickets.map((ticket) => (
          <TableRow key={ticket.id}>
            ...
            <TableCell className="font-mono text-xs">{ticket.tramite || '-'}</TableCell>
            <TableCell>{ticket.status}</TableCell>
            <TableCell>{ticket.verificationStatus}</TableCell>
          </TableRow>
        ))}
